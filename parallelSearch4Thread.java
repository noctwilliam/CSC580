...
public class parallelSearch4Thread {
	public static void main(String args[]){
		...
		Thread4 thread4 = new Thread4(array, key);
...
class Thread4 extends Thread{
	...
	// Constructor to initialize the array and search key
	public Thread4(int[] array, int searchKey) { 
		array1 = array;
		this.searchKey = searchKey;
	}
	...
	public void run() {
		...
		for (int i = 0; i < array1.length / 4; i++) {
			...
			if (array1[i] == searchKey) {
				// If it is, update the index and print a message
				index = i;
				System.out.println("Exit from thread 4. Found key in Thread 4 at index : "+index);
			}
		}
		// If the index was not updated, print a message indicating that the key was not found
		if (index == -1)
		System.out.println("There is no key found in Thread 4");
